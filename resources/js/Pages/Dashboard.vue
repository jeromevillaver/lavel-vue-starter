...
import preview1 from '/resources/dist/images/preview-1.jpg';
import preview10 from '/resources/dist/images/preview-10.jpg';
import preview2 from '/resources/dist/images/preview-2.jpg';
import preview13 from '/resources/dist/images/preview-13.jpg';
import preview3 from '/resources/dist/images/preview-3.jpg';
import preview4 from '/resources/dist/images/preview-4.jpg';
import preview15 from '/resources/dist/images/preview-15.jpg';
import profile13 from '/resources/dist/images/profile-13.jpg';
import profile8 from '/resources/dist/images/profile-8.jpg';
import profile15 from '/resources/dist/images/profile-15.jpg';
import profile7 from '/resources/dist/images/profile-7.jpg';
import profile3 from '/resources/dist/images/profile-3.jpg';
import profile4 from '/resources/dist/images/profile-4.jpg';
import profile11 from '/resources/dist/images/profile-11.jpg';
import profile6 from '/resources/dist/images/profile-6.jpg';
</script>
                            ...
                            <div class="box grid grid-cols-12">
                                <div class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                                    ...
                                    <div class="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12">
                                        My Total Assets <i data-lucide="alert-circle" class="tooltip w-4 h-4 ml-1.5"
                                            title="Total value of your sales: $158.409.416"></i> </div>
                                    <div class="flex items-center justify-start mt-4">
                                        <div class="relative text-2xl font-medium pl-3 ml-0.5"> <span
                                                class="absolute text-xl font-medium top-0 left-0 -ml-0.5">$</span>
                                            1,413,102.02 </div>
                    ...
                    <div class="col-span-12 lg:col-span-8 xl:col-span-4 mt-6">
                        ...
                        <div class="mt-5">
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" :src="profile13">
                                    </div>
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" :src="profile8">
                                    </div>
                                    <div class="ml-4 mr-auto">
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" :src="profile15">
                                    </div>
                                    <div class="ml-4 mr-auto">
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" :src="profile7">
                                    </div>
                                    <div class="ml-4 mr-auto">
                                            ...
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview10" title="Uploaded at 18 June 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview2" title="Uploaded at 10 August 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview13" title="Uploaded at 7 October 2020">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview3" title="Uploaded at 16 November 2021">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview4" title="Uploaded at 22 April 2021">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview15" title="Uploaded at 28 October 2022">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview1" title="Uploaded at 28 May 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview1" title="Uploaded at 15 May 2021">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview15" title="Uploaded at 16 September 2021">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview13" title="Uploaded at 30 March 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview1" title="Uploaded at 16 September 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                        :src="preview15" title="Uploaded at 24 May 2022">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                            ...
                            <div
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        ...
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" :src="profile3">
                                        </div>
                                    </div>
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" :src="profile4">
                                        </div>
                                    </div>
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex mt-2">
                                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in"
                                                    ...
                                                    <img alt="Midone - HTML Admin Template"
                                                        class="rounded-md border border-white" :src="preview4">
                                                </div>
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" :src="profile11">
                                        </div>
                                    </div>
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div class="flex items-center">
                                ...
                                <div class="intro-x relative flex items-center mb-3">
                                    <div
                                        class="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" :src="profile6">
                                        </div>
                                    </div>
                                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div class="flex items-center">
